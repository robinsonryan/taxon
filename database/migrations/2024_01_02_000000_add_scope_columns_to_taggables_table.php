...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Drop the old unique constraint and add a new one that includes scope columns
        Schema::table($pivotTable, function (Blueprint $table) use ($tenantColumn) {
        ...
        Schema::table($pivotTable, function (Blueprint $table) use ($tenantColumn) {
            $table->unique(
                ['tag_id', 'taggable_type', 'taggable_id', 'scope_type', 'scope_id', $tenantColumn],
                'taggables_unique_tag_model_scope_tenant'
            );
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table($pivotTable, function (Blueprint $table) use ($tenantColumn) {
            $table->dropUnique('taggables_unique_tag_model_scope_tenant');
        });
